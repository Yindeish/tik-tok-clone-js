...
// import VideosGetter from "./video-getters";
var VideoPlayer = /*#__PURE__*/function () {
  function VideoPlayer() {
    _classCallCheck(this, VideoPlayer);
    _defineProperty(this, "videoIsPlaying", false);
    _defineProperty(this, "currentVideoPlaying", null);
    _defineProperty(this, "currentVideoPaused", null);
  }
  _createClass(VideoPlayer, [{
    key: "getVideos",
    value: function getVideos() {
      this.VideosGetter().run();
    }
  }, {
    ...
    value: function retrieveElements() {
      ...
      var videos = gottenElements.videos;
      _toConsumableArray(videos).forEach(function (video) {
        _this.click(video, _this.playVideo(video));
        _this.click(video, _this.pauseVideo(video));
      });
    }
  }, {
    key: "click",
    value: function click(element, runFn) {
